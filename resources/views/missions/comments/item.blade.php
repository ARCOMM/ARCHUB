    ...
    <div id="comment-{{ $comment->id }}" class="mission-comment-item">
        ...
        <span class="mission-comment-item-timestamp" title="{{ $comment->created_at }}">
            ...
            @if ($comment->isMine())
                ...
                <a href="javascript:void(0)" title="Edit" class="btn btn-sm m-a-0 mission-comment-control mission-comment-control-edit" data-id="{{ $comment->id }}">
                    <i class="fa fa-pencil"></i>
                </a>

                <a href="javascript:void(0)" title="Delete" class="btn btn-sm m-a-0 mission-comment-control mission-comment-control-delete" data-id="{{ $comment->id }}">
